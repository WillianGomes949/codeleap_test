...
export default function Signup() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#DDDDDD] via-[#e8e8e8] to-[#d0d0d0] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          <div className="bg-gradient-to-br from-[#7695EC] to-[#5a7bd4] p-4 rounded-2xl shadow-lg shadow-[#7695EC]/30">
        ...
        >
          <h1 className="text-2xl md:text-3xl font-bold mb-2 text-center bg-gradient-to-r from-[#7695EC] to-[#47B960] bg-clip-text text-transparent">
            Welcome to CodeLeap!
          </h1>
          ...
          >
            <motion.button
              ...
              className={`w-full group relative overflow-hidden rounded-xl py-4 font-bold text-lg tracking-wide transition-all duration-300
                ${name.trim() 
                  ? 'bg-gradient-to-r from-[#7695EC] to-[#5a7bd4] text-white shadow-lg shadow-[#7695EC]/40 hover:shadow-xl hover:shadow-[#7695EC]/50' 
            ...
            >
              ...
              {name.trim() && (
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-[#5a7bd4] to-[#7695EC]"
                  initial={{ x: '100%' }}
                  whileHover={{ x: 0 }}
