  ...
  return (
    <div className="w-full mt-6 space-y-6">
      {skeletons.map((_, index) => (
        ...
        >
          {/* Header Skeleton */}
          <div className="bg-gradient-to-r from-[#7695EC]/20 to-[#5a7bd4]/20 h-16 px-5 flex items-center justify-between">
          ...
          <div className="p-6 space-y-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="h-8 bg-[#f8f9fa] rounded-full w-28 animate-pulse" />
            </div>
