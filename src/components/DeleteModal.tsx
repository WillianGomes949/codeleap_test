      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex justify-between items-start bg-linear-to-br from-danger/10 to-danger/5 p-6 pb-2">
            <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <div className="p-6 pt-4">
              ...
              <p className="text-neutral-500 mb-8 leading-relaxed">
                ...
                <span className="font-semibold text-neutral-700 bg-neutral-100 px-2 py-1 rounded-md">
                  {itemName}
                </span>
                ?
                <br />
